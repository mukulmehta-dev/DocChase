  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8 p-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-xs text-neutral-300 leading-relaxed">
        <p className="font-semibold text-white mb-1">Our Privacy Commitment</p>
        <p>
      ...
      <div className="space-y-8 text-neutral-300 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">3. Data Security & Storage</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">4. Third-Party Infrastructure Providers</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">5. Data Retention & Account Deletion</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">7. Contact Information</h2>
          <p>
      ...
      <div className="mt-12 pt-6 border-t border-white/[0.08] flex items-center justify-between">
        ...
        <Link to="/terms" className="text-xs font-medium text-neutral-400 hover:text-white">
          Terms of Service →
        </Link>
      </div>
    </div>
