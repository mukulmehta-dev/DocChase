  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8 pb-6 border-b border-white/[0.08]">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/[0.05] border border-white/[0.1] text-xs font-medium text-neutral-300 mb-3">
      ...
      {/* Notice Banner */}
      <div className="mb-8 p-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-xs text-neutral-300 leading-relaxed">
        <p className="font-semibold text-white mb-1">Standard Operating Terms Notice</p>
        <p>
      ...
      <div className="space-y-8 text-neutral-300 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">4. Client Portals & Secure Access Links</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">5. Document Ownership & Storage</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">6. Subscription & Billing</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">9. Contact & Inquiries</h2>
          <p>
            Questions regarding these Terms of Service may be directed to{' '}
            <a href="mailto:support@docchase.com" className="text-white font-medium underline hover:text-neutral-300">
      ...
      <div className="mt-12 pt-6 border-t border-white/[0.08] flex items-center justify-between">
        <Link to="/sign-up" className="text-xs font-semibold text-white hover:underline flex items-center gap-1">
          <span className="material-symbols-outlined text-[16px]">arrow_back</span>
          <span>Back to Sign Up</span>
        </Link>
        <Link to="/privacy" className="text-xs font-medium text-neutral-400 hover:text-white">
          Privacy Policy →
        </Link>
      </div>
    </div>
